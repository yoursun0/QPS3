...
--
-- Procedure `qpsis`.`sp_insert_admin_log`
--

DROP PROCEDURE IF EXISTS `sp_insert_admin_log`;
DELIMITER $$
...
CREATE PROCEDURE `sp_insert_admin_log`(
    ...
    p_function_id            VARCHAR(50) ,
    p_record_key             VARCHAR(50) ,
...
BEGIN
	...
	(
		...
		p_entity_name, p_record_key, 'A', SYSDATE(), p_remarks
	);
