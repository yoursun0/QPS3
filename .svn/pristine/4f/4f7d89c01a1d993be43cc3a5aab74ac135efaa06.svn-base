...
public class ACLDataBean extends DataBean {
    ...
    public List selectInactiveUsers() throws SysException {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                acl.setEmailInd(rs.getInt("email_indicator"));
    ...
    public int insertACL(ACLInfo acl, SecurityContext secCtx) throws SysException {
        ...
        try {
            ...
            cs.setInt("p_email_ind", acl.getEmailInd());
            ...
            String err = "Duplicate keys found! User already exists in the access control list.";
    ...
    public int createTempACL() throws SysException {
        ...
        try {
            ...
            String error = "Duplicate keys found! User already exists in the access control list.";
