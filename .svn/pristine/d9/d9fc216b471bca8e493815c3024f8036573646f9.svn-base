...
public class ContractorDataBean extends DataBean {
    ...
    public List<ContractorInfo> selectContractor() throws SysException {
    	
        return selectContractor("","");
        
    }
    
    public List<ContractorInfo> selectContractor(String order_by, String order_dir) throws SysException {
    ...
    public List<ContractorInfo> selectContractorByCatgp(String catgp) throws SysException {
