...
<%
    ...
    String searched_activity = "ACRUSERENQ,DRENQ,QSENQ,RATEVALID_CHALLENGE,QSENQ_CHALLENGE,CPAR_CHALLENGE,CPARADD,CPARUPDATE,CPARFINALIZE,CPARDELETE,CHPWD";
                                ...
                                <tr> 
                                    ...
                                    <td class="tableVerticalContentAlignLeft1"> 
                                        <p> 
                                            ...
                                            <input type="checkbox" name="Activity" value="CPARADD" <%=activityList.contains("CPARADD")?"CHECKED":""%>>
                                            Create CPAR Records<br>
                                            <input type="checkbox" name="Activity" value="CPARUPDATE" <%=activityList.contains("CPARUPDATE")?"CHECKED":""%>>
                                            Update CPAR Records<br>
                                            <input type="checkbox" name="Activity" value="CPARFINALIZE" <%=activityList.contains("CPARFINALIZE")?"CHECKED":""%>>
                                            Finalize CPAR Records<br>
                                            <input type="checkbox" name="Activity" value="CPARDELETE" <%=activityList.contains("CPARDELETE")?"CHECKED":""%>>
                                            Delete CPAR Records<br>
