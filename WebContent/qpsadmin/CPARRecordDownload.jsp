...
<%
    ...
    HashMap searchParaHashMap = (HashMap) session.getAttribute("DOWNLOAD_CPAR_LIST_SEARCH_PARAMETER");
...
<html>
    ...
    <body> 
        ...
        <fieldset class="function"> 
                                    ...
                                    <td> 
	                                    <form name="form1" method="POST" action="CPARRecordDownload.jsp">
                                            ...
                                            <table  width="98%" cellspacing="1" class="tableBackground">
                                                ...
                                                <tr> 
                                                    <td class="tableVerticalHeaderAlignLeft1" width="25%">Assessment Period</td>
                                                ...
                                                <tr> 
                                                    <td class="tableVerticalHeaderAlignLeft1" width="25%">CPAR Stage</td>
                                                    <td class="tableVerticalContentAlignLeft1" width="75%"> 
                                                        <select id="CPARState" name="CPARState">
                                                            <option value="">Please select CPAR Stage</option>
            ...
            <%session.removeAttribute("DOWNLOAD_CPAR_LIST_SEARCH_PARAMETER");%> 
        </fieldset> 		    
    </body>
