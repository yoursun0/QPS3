...
<%
        ...
        if (allCPARList == null)
        {throw new Exception( "Unable to get CPAR info.");}   
                        ...
                        <div align="center"> 
                            <table width="98%" cellspacing="1" class="tableBackground">
                                <tr> 
                                    ...
                                    <td align="center" width="10%" class="tableHeaderAlignCenter1">Stage</td>
                                    <td align="center" width="23%" class="tableHeaderAlignCenter1">Action</td>
                                </tr>
							  <%
                                    // Display records
                                    for (int i = allCPARList.size()-1; i>=0 ; i--) {
                                        ...
                                        String cparStage = "Draft";
                                        if ("f".equals(cpar.getFinalized())) cparStage = "Finalized";
                                        if ("r".equals(cpar.getFinalized())) cparStage = "Released";
                                %>
                                <tr valign="top" class="tableContentAlignCenter1"> 
                                    ...
                                    <td align="center" width="10%" nowrap><%=cparStage %></td>
                                   <td align="center" width="23%" nowrap>
                                    <%if ( ("r".equals(cpar.getFinalized())) ){%>
                                    <a href="#"><img name="UnreleaseInListPage" src="../images/s_btn_unrelease.jpg" width="63" height="21" alt="Unrelease" border="0" onClick="selectaction(form1,this,'<%=cpar.getCparNo() %>')"></a>
                                    <%} else  {%> 
                                    <a href="#"><img name="ReleaseInListPage" src="../images/s_btn_release.jpg" width="63" height="21" alt="Release" border="0" onClick="selectaction(form1,this,'<%=cpar.getCparNo() %>')"></a>
                                    <%} %>
                                     ...
                                     <a href="#"><img name="History" src="../images/s_btn_history.jpg" width="63" height="21" alt="History" border="0" onClick="selectaction(form1,this,'<%=cpar.getCparNo() %>')"></a>                                   
                                    </td>
                                </tr>
                                <%} // End for %>
                            </table>
