...
Calendar.prototype.buildString = function()
{
    ...
    {
        //tmpStr += '<table border="0" cellspacing="0" cellpadding="0"><tr><td><a href="javascript: g_Calendar.changeMonth(-1);"><img name="calendar" src="' + 'http://' + location.hostname + '/examples/calendar/images/down.gif" width="8" height="12" border="0" alt=""></a></td><td class="cal" width="100%" align="center">' + this.months[this.month] + '</td><td class="cal"><a href="javascript: g_Calendar.changeMonth(+1);"><img name="calendar" src="' + 'http://' + location.hostname + '/examples/calendar/images/up.gif" width="8" height="12" border="0" alt=""></a></td></tr></table>';
...
{
    this.month = this.containerLayer.ownerDocument.forms[0].month.selectedIndex;
    this.writeString(this.buildString());
}

Calendar.prototype.inputChange = function()
{
    var tmp = this.containerLayer.ownerDocument.forms[0].year;
...
Calendar.prototype.clickDay = function(day)
{
    ...
    if (this.dateFormat=='dd-mmm-yyyy' || this.dateFormat=='dd/mmm/yyyy')
    ...
    if (this.dateFormat=='yyyy-mm-dd')
        tmp.value = this.year + this.dateDelim + (this.month+1) + this.dateDelim + day;
...
{
    if (g_Calendar == null) return; // Added by Wilson
