        ...
        <form name="form" method="POST" target="" action="">
            ...
            <fieldset class="function">  
                ...
                <fieldset class="sub_function">
                    ...
                    <table width="500px" class="no_border">
                    <tr><td><li>Security Risk Assessment</li></td></tr>
                    <tr><td><li>Security Audit</li></td></tr>
                    <tr><td><li>Security Management Design and Implementation Services</li></td></tr>
                    <tr><td><li>Independent Testing</li></td></tr>
                    </table>              
                    <%
                    ...
                    <table class="list">    
                        <tr class="list_header_gradient_blue">
                            <td class="list" colspan="2" align="center"><%=CeilingRateCat4Info.WorkingLocationName[i]%></td>
                        ...
                        <%
                            ...
                            for (int j = 0; j < allCeilingRateInfo.size(); j++)
                            {
                                ...
                                CeilingRateCat4Info aCRCat4Info = (CeilingRateCat4Info)allCeilingRateInfo.get(j);
                        ...
                        <tr class="<%=rowClassName%>" onmouseover="this.className='list_hl'" onmouseout="this.className='<%=rowClassName%>'">                        
                            <td class="list" width="120"><%=aCRCat4Info.getContractorID()%></td>
                            <td class="list" width="30" ><%=aCRCat4Info.getCurrency()%></td>

                            <%
                                for (int k = 0; k < CeilingRateCat4Info.NumOfOneOffStaffCategory; k++)
                                {
                                String displayValue = (aCRCat4Info.getOneOffStaffRate(k, i) == -999) ? "No Offer" : "";
                            %>        
                            <td class="list" align="center"> <input type="text" class="text" name="TxtSR__<%=aCRCat4Info.getContractorID()%>__<%=aCRCat4Info.toOneOffStaffRateTableField(k, i)%>" style="width: 60px" value="<%=displayValue%>"></td> 
                            <%
                                } // end for k
                            %>
                        </tr> 
                    ...
                    <fieldset class="sub_function">
                    <legend class="sub_function">Staff Rates for On-going Services</legend>
                    <table width="500px" class="no_border">
                       <tr><td><li>Information Security Incident Response Support Services</li></td></tr>
                    </table>                     
                    
                    <table class="list">   
                        <tr class="list_header_gradient_blue">
                            <td class="list" colspan="2">Non-Resident/Off-Shore</td>
                            <td class="list" colspan="10" align="center">Hourly Rate</td>
                        </tr>
                        <tr class="list_header_gradient_gray">
                            <td class="list" colspan="2">&nbsp;</td>
                            <td class="list" colspan="10" align="center">Standard Staff Category</td>
                        ...
                        <tr class="list">
                            <td class="list" colspan="2">&nbsp;</td>
                            <td class="list" colspan="2" align="center">1</td>
                            <td class="list" colspan="2" align="center">2</td>
                            <td class="list" colspan="2" align="center">3</td>
                            <td class="list" colspan="2" align="center">4</td>
                            <td class="list" colspan="2" align="center">5</td>
                        </tr>
                        <tr class="list">
                            <td class="list" colspan="2">Office/Non-office Hours</td>
                            <td class="list" align="center">Office Hours</td>
                            <td class="list" align="center">Non-office Hours</td>
                            <td class="list" align="center">Office Hours</td>
                            <td class="list" align="center">Non-office Hours</td>
                            <td class="list" align="center">Office Hours</td>
                            <td class="list" align="center">Non-office Hours</td>
                        ...
                        <%
                            ...
                            for (int i = 0; i < allCeilingRateInfo.size(); i++)
                            {
                                count++;

                                CeilingRateCat4Info aCRCat4Info = (CeilingRateCat4Info)allCeilingRateInfo.get(i);
                        ...
                        <tr class="<%=rowClassName%>" onmouseover="this.className='list_hl'" onmouseout="this.className='<%=rowClassName%>'">                        
                            ...
                            <%
                                for (int j = 0; j < CeilingRateCat4Info.NumOfOnGoingStaffCategory ; j++) // Staff Category
                                {
                                        for (int k = 0; k < 2 ; k++) // Loop through first two working hour types
                                        {
                                            String displayValue = (aCRCat4Info.getOnGoingStaffRate(j, k) == -999) ? "No Offer" : "";
                            %>                        
                            <td class="list" align="center">
                                <input type="text" class="text" name="TxtSR__<%=aCRCat4Info.getContractorID()%>__<%=aCRCat4Info.toOnGoingStaffRateTableField(j, k)%>" style="width: 60px" value="<%=displayValue%>">
                            </td>
                            <%      
                                }// end for k
                                } //end for j
                    ...
                    <table width="500px" class="no_border">
                    <tr><td><li>IT Security Monitoring Services</li></td></tr>
                    </table>   
                    <table class="list">           
                        <tr class="list_header_gradient_blue">
                            <td class="list" colspan="2">Non-Resident/Off-Shore</td>
                            <td class="list" colspan="5" align="center">24-Hour Round-the-clock Daily Rate</td>
                        </tr>
                        <tr class="list_header_gradient_gray">
                            <td class="list" colspan="2">&nbsp;</td>
                            <td class="list" colspan="5" align="center">Standard Staff Category</td>
                        </tr>
                        <tr class="list">
                            <td class="list" colspan="2">&nbsp;</td>
                            <td class="list" align="center">1</td>
                        ...
                        <tr class="<%=rowClassName%>" onmouseover="this.className='list_hl'" onmouseout="this.className='<%=rowClassName%>'">
                            ...
                            <%
                                for (int j = 0; j < CeilingRateCat4Info.NumOfOnGoingStaffCategory ; j++) // Staff Category
                                {
                                    String displayValue = (aCRCat4Info.getOnGoingStaffRate(j, 2) == -999) ? "No Offer" : "";
                            %>                        
                            <td class="list" align="center">
                                <input type="text" class="text" name="TxtSR__<%=aCRCat4Info.getContractorID()%>__<%=aCRCat4Info.toOnGoingStaffRateTableField(j, 2)%>" style="width: 60px" value="<%=displayValue%>">
                            </td>
                            <%      
                                } //end for j
                            %>
