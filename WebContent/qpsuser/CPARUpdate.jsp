        ...
        <fieldset class="function"> 
            ...
            <fieldset class="sub_function"> 
                ...
                <table border="0" cellspacing="0" cellpadding="0" width="98%" class="tableNoBorder" align="center">
                    ...
                    <td style="display:block" id="calendar_link"> 
                    	<% if("".equals(getValue(nextDate))){ %>
                        <input class="text" type="text" name="IssuedDate" value="<%=SysManager.getStringfromSQLDate(cpar.getStartDate()) %>" >
                    ...
                    <td style="display:block" id="calendar_link"> 
                        <input class="text" type="text" name="ClosingDate" value="<%=SysManager.getStringfromSQLDate(cpar.getEndDate()) %>" >
                        <a href="javascript: void(0);" 
                        onMouseOver="if (timeoutId) clearTimeout(timeoutId); window.status='Show Calendar'; return true;" 
                        onMouseOut="if (timeoutDelay) calendarTimeout(); window.status='';" 
            ...
            <table border="0" cellpadding="3" align="center">
                    ...
                    <tr>
                        ...
                        <td >                            
                            <div align="center"><img type="image" name="Save" class="function_button" src="../images/btn_save.jpg" alt="Save" onclick="selectaction(form1,this,<%=cparNo %>)"></div>
                        </td>
                        <td>
                            <div align="center"><img type="image" name="Finalize" class="function_button" src="../images/btn_finalize.jpg" alt="Finalize" onclick="selectaction(form1,this,<%=cparNo %>)"></div>
                        </td>
                    </tr>
                </table>
                <input type="hidden" name="PostScreen" value="CPARList.servlet">
                <input type="hidden" name="cparNo" value="">
                <input type="hidden" name="finalized" value="s">
