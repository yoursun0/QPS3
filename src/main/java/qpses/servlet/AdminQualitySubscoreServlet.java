...
private void performQualitySubscorePrintReport(HttpServletRequest request, HttpServletResponse response)
    throws ServletException, IOException
    {
        try
        {
            ...
            QualitySubscoreDataBean qsDB = new QualitySubscoreDataBean();
            List<QualitySubscoreInfo> QualitySubscoreList=qsDB.getQualitySubscoreByPeriod(effectivePeriodID, "1");
            
            QualitySubscoreInfo qs = (QualitySubscoreInfo) QualitySubscoreList.get(0);
            ...
            for (String category : categories){
            	...
            	QualitySubscoreList=qsDB.getQualitySubscoreByPeriod(effectivePeriodID, category);
    	        ...
    	        for (int i = 0; i < QualitySubscoreList.size(); i++)
    	        {
                
    	        	// Data row
    	        	qs = (QualitySubscoreInfo) QualitySubscoreList.get(i);
