...
public class SecurityDataBean extends DataBean {
    ...
    private static final String SELECT_ADMIN_EMAILS =
            "SELECT email from acl where email_indicator = '-1'";
    ...
    throws SecurityException,SysException {
        ...
        return secCtx;
           ...
           */
    protected List createAccessPrivileges(SecurityContext secCtx)
    throws SecurityException,SysException {
        List pvgList = new ArrayList();
        Connection connection = null;
        CallableStatement cs = null;
        int returnCode =0;
        try {
   ...
   */
    ...
    public void insertChallengeLog(String userID, String dpDeptID, String soaDeptID, String functionID, String question, String answer, 
