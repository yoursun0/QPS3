...
public class AvgCeilingRateDataBean extends DataBean {
    ...
    public List selectAvgCeilingRate(String order_by, String order_dir) throws SysException {
    ...
    public List searchAvgCeilingRate(AvgCeilingRateInfo searchACR,String order_by, String order_dir) throws SysException {
        
        List AvgCeilingRateList = new ArrayList();
        try {
            CallableStatement cs = null;
    ...
    public int insertAvgCeilingRate(AvgCeilingRateInfo acr, FileItem pdffile) throws SysException {
        ...
        try {
            ...
            String msg1 = "File already exist for service category " +acr.getServiceCategory() + " with the effective date  \""+ acr.getEffectiveDate().toString()+"\".";
    ...
    public int deleteAvgCeilingRate(AvgCeilingRateInfo acr,SecurityContext secCtx) throws SysException {
        ...
        try {
            ...
            returnCode =cs.getInt("return_code");
            // check execution result
            String msg1 = "Service Category: "+acr.getServiceCategory() + "; Effective Date: " + acr.getEffectiveDate().toString()+";";
    ...
    public int releaseAvgCeilingRate(AvgCeilingRateInfo acr, SecurityContext secCtx) throws SysException {
        ...
        try {
            ...
            // check execution result
            String msg1 = "Service Category: "+acr.getServiceCategory() + "; Effective Date: " + acr.getEffectiveDate().toString()+";";
            String msg2 = "No record was update! <BR>"+
                    		"Service Category: "+acr.getServiceCategory() + "; Effective Date: " + acr.getEffectiveDate().toString()+";";
            commitResult(returnCode, result, msg1, msg2);
