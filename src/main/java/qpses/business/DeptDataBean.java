...
public class DeptDataBean extends DataBean {
    ...
    public List<DeptInfo> selectDept() throws SysException {
    	
        return selectDept("","");
        
    }
    
    public List<DeptInfo> selectDept(String order_by, String order_dir) throws SysException {
        
        List<DeptInfo> allDeptList = new ArrayList<DeptInfo>();
        try {
    ...
    public List<DeptInfo> searchDept(DeptInfo searchDept,String order_by, String order_dir) throws SysException {
