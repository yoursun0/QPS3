...
public final class SysManager
{
    ...
    /** Convert sql date format to string */
    public static String getSpecialFormatStringfromSQLDate(java.sql.Date aDate) throws SysException
    {
    	if (aDate == null){
    		return "";
    	}
        ...
        SimpleDateFormat sdfOrg = new SimpleDateFormat("yyyy-MM-dd", Locale.ENGLISH);
        SimpleDateFormat sdfNew = new SimpleDateFormat("dd/MM/yy", Locale.ENGLISH);
    ...
    /** Convert sql date format to string */
    public static String getDateStringfromSQLDate(java.sql.Date aDate) throws SysException
    {
    	if (aDate == null){
    		return "";
    	}
    ...
    public static String getStringfromSQLDateTime(String aDateTime) throws SysException
    {
        ...
        SimpleDateFormat sdfNew = new SimpleDateFormat("dd-MMM-yyyy HH:mm", Locale.ENGLISH);
