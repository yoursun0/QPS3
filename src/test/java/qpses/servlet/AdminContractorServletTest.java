...
public class AdminContractorServletTest {

    private AdminContractorServlet servlet;
	...
	public void setUp(){
        ...
        servlet = new TestForAdminContractorServlet();
	...
	@Test
	public void testPerformContractorAdd() throws ServletException, IOException {
		
		expect(request.getServletPath()).andReturn("/qpsadmin/ContractorAdd.servlet").anyTimes();
        ...
        expectLastCall().anyTimes();
        session.setAttribute(isA(String.class),isA(ContractorInfo.class));
        expectLastCall().anyTimes();
	...
	@Test
	public void testPerformContractorUpdate() throws ServletException, IOException {
		
		expect(request.getServletPath()).andReturn("/qpsadmin/ContractorUpdate.servlet").anyTimes();
		expect(request.getParameter("UserId")).andReturn("junit.test").anyTimes();
		expect(request.getParameter("DeptId")).andReturn("ogcio+OGCIO").anyTimes();
		expect(request.getParameter("EffectiveDate")).andReturn("11-May-2013").anyTimes();
		expect(request.getParameter("ExpiryDate")).andReturn("11-May-2015").anyTimes();
	...
	@Test
	public void testPerformContractorDelete() throws ServletException, IOException {
		
		expect(request.getServletPath()).andReturn("/qpsadmin/ContractorDelete.servlet").anyTimes();
		expect(request.getParameter("UserId")).andReturn("junit.test").anyTimes();
		expect(request.getParameter("DeptId")).andReturn("ogcio+OGCIO").anyTimes();
		expect(request.getParameter("EffectiveDate")).andReturn("11-May-2013").anyTimes();
		expect(request.getParameter("ExpiryDate")).andReturn("11-May-2015").anyTimes();
